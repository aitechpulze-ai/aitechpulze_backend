              ...
              <div className="max-w-3xl">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="w-full py-3.5 bg-gradient-to-r from-violet-600 to-purple-600 text-white font-bold rounded-xl shadow-lg shadow-violet-500/20 hover:opacity-90 transition-all text-sm flex items-center justify-center gap-2 cursor-pointer"
                  >
