    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-[#060713] relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none opacity-20">
          ...
          <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-indigo-900 rounded-full blur-[100px]" />
        </div>
      ...
      {/* Products List */}
      <section className="py-16 bg-[#060713]">
            ...
            return (
              ...
              >
                ...
                <div className="w-full lg:w-1/2">
                  <div className="relative p-6 md:p-8 bg-[#0d0e22]/50 rounded-[2rem] border border-white/10 group transition-all duration-300 hover:border-blue-500/30 hover:shadow-[0_20px_60px_rgba(6,182,212,0.15)]">
                    <div className="relative rounded-2xl overflow-hidden aspect-[4/3] md:aspect-video lg:aspect-[4/3] shadow-inner bg-[#060713]">
                      <img 
                        src={p.image} 
                        alt={p.name} 
                ...
                <div className="w-full lg:w-1/2">
                  ...
                  <div className="flex flex-wrap gap-2 mb-10">
                    {p.tech.map((t, idx) => (
                      <span key={idx} className="px-4 py-1.5 bg-blue-950/40 text-blue-400 text-xs font-bold rounded-full border border-blue-900/30">
                        {t}
                      </span>
                    ))}
                  </div>
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="inline-flex items-center justify-center px-6 py-3.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm font-bold rounded-xl shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 hover:-translate-y-0.5 transition-all cursor-pointer"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="inline-flex items-center gap-2 justify-center px-6 py-3.5 bg-white/5 text-white text-sm font-bold rounded-xl border border-white/10 shadow-sm hover:bg-white/10 transition-all cursor-pointer"
              >
