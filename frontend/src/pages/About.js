    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-[#060713] relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none opacity-20">
          ...
          <div className="absolute bottom-0 left-1/4 w-[500px] h-[500px] bg-purple-900 rounded-full blur-[100px]" />
        </div>
        ...
        <div className="container mx-auto px-6 max-w-4xl text-center relative z-10">
          <motion.div {...fadeUp(0)}>
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-white tracking-tight mb-4">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Delivering Intelligent Solutions.</span>
            </h1>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link 
                to="/contact" 
                className="inline-flex items-center justify-center px-6 py-3 bg-white/5 text-white text-sm font-bold rounded-xl border border-white/10 shadow-sm hover:bg-white/10 transition-all cursor-pointer"
              >
                Get In Touch
              </Link>
            </div>
      ...
      {/* Value Props Row 1 */}
      <section className="py-6 bg-[#060713] relative z-10">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <motion.div {...fadeUp(0.1)} className="bg-[#0d0e22]/50 rounded-3xl p-8 text-center flex flex-col items-center border border-white/10">
              <div className="text-slate-300 mb-4 opacity-80">
              ...
              <h3 className="text-sm font-bold text-white mb-3">Business Products</h3>
            ...
            <motion.div {...fadeUp(0.2)} className="bg-[#0d0e22]/50 rounded-3xl p-8 text-center flex flex-col items-center border border-white/10">
              <div className="text-slate-300 mb-4 opacity-80">
              ...
              <h3 className="text-sm font-bold text-white mb-3">Technology Services</h3>
              <p className="text-xs text-slate-400 leading-relaxed max-w-[240px]">
                Custom AI, web, mobile, SaaS, and cloud development services for startups, businesses, and enterprises across India and beyond.
              </p>
            </motion.div>

            <motion.div {...fadeUp(0.3)} className="bg-[#0d0e22]/50 rounded-3xl p-8 text-center flex flex-col items-center border border-white/10">
              <div className="text-slate-300 mb-4 opacity-80">
              ...
              <h3 className="text-sm font-bold text-white mb-3">Academic Innovation Hub</h3>
              <p className="text-xs text-slate-400 leading-relaxed max-w-[240px]">
      ...
      <section className="py-6 bg-[#060713]">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <motion.div {...fadeUp(0.4)} className="bg-[#0d0e22]/50 rounded-3xl p-8 border border-white/10">
              <div className="text-slate-300 mb-4 opacity-80">
            ...
            <motion.div {...fadeUp(0.5)} className="bg-emerald-950/20 rounded-3xl p-8 border border-emerald-900/30">
              <div className="text-emerald-400 mb-4 opacity-80">
              ...
              <p className="text-xs text-emerald-300 leading-relaxed max-w-[320px]">
      ...
      {/* Stats */}
      <section className="py-12 bg-[#060713] relative border-t border-white/5">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <motion.div {...fadeUp(0.1)} className="bg-[#0d0e22]/50 rounded-3xl p-6 text-center border border-white/10 shadow-sm">
            ...
            <motion.div {...fadeUp(0.2)} className="bg-[#0d0e22]/50 rounded-3xl p-6 text-center border border-white/10 shadow-sm">
              <div className="text-2xl font-extrabold text-blue-400 mb-1">3</div>
              <div className="text-[9px] font-bold tracking-widest uppercase text-slate-500">LIVE BUSINESS PRODUCTS</div>
            </motion.div>
            <motion.div {...fadeUp(0.3)} className="bg-[#0d0e22]/50 rounded-3xl p-6 text-center border border-white/10 shadow-sm">
              <div className="text-2xl font-extrabold text-blue-400 mb-1">24h</div>
              <div className="text-[9px] font-bold tracking-widest uppercase text-slate-500">RESPONSE WINDOW</div>
            </motion.div>
            <motion.div {...fadeUp(0.4)} className="bg-[#0d0e22]/50 rounded-3xl p-6 text-center border border-white/10 shadow-sm">
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          <motion.div {...fadeUp(0)} className="mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-white tracking-tight">
              How We <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Got Here</span>
            </h2>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <motion.div {...fadeUp(0.1)} className="bg-[#0d0e22]/50 rounded-3xl p-8 border border-white/10 shadow-sm">
              <div className="text-[9px] font-bold tracking-widest uppercase text-cyan-400 mb-3">START</div>
              <h3 className="text-sm font-bold text-white mb-3">Founded with a Purpose</h3>
            ...
            <motion.div {...fadeUp(0.2)} className="bg-[#0d0e22]/50 rounded-3xl p-8 border border-white/10 shadow-sm">
              <div className="text-[9px] font-bold tracking-widest uppercase text-cyan-400 mb-3">GROWTH</div>
              <h3 className="text-sm font-bold text-white mb-3">First Business Products</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
                Expanded into building enterprise products — PKROUTEX and iPrintZone — solving real business challenges.
              </p>
            </motion.div>
            <motion.div {...fadeUp(0.3)} className="bg-[#0d0e22]/50 rounded-3xl p-8 border border-white/10 shadow-sm">
              <div className="text-[9px] font-bold tracking-widest uppercase text-cyan-400 mb-3">TODAY</div>
              <h3 className="text-sm font-bold text-white mb-3">3 Thriving Divisions</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
                Now operating 3 divisions: Business Products, Technology Services, and the Academic Innovation Hub.
              </p>
            </motion.div>
            <motion.div {...fadeUp(0.4)} className="bg-[#0d0e22]/50 rounded-3xl p-8 border border-white/10 shadow-sm">
              <div className="text-[9px] font-bold tracking-widest uppercase text-cyan-400 mb-3">FUTURE</div>
              <h3 className="text-sm font-bold text-white mb-3">Scaling Innovation</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
      ...
      {/* Tech Stack */}
      <section className="py-24 bg-[#060713] relative border-t border-white/5">
        <div className="container mx-auto px-6 max-w-4xl text-center">
          <motion.div {...fadeUp(0)} className="mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-white tracking-tight">
              Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Tech Stack</span>
            </h2>
          </motion.div>
          ...
          <motion.div {...fadeUp(0.2)} className="flex flex-wrap justify-center gap-3">
            {['React JS', 'Spring Boot', 'Python', 'TensorFlow', 'Firebase', 'MySQL', 'AWS', 'Docker', 'Node.js', 'Flask', 'OpenCV', 'Scikit-learn'].map((tech) => (
              <div key={tech} className="px-5 py-2.5 bg-blue-950/40 text-blue-400 text-xs font-bold rounded-full border border-blue-900/30 shadow-sm">
                {tech}
              </div>
            ))}
          </motion.div>
      ...
      <section className="py-24 bg-[#060713] border-t border-white/5">
        <div className="container mx-auto px-6 max-w-5xl text-center">
          <motion.div {...fadeUp(0)} className="mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-white tracking-tight">
              Built for <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Every Ambition</span>
            </h2>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <motion.div {...fadeUp(0.1)} className="bg-[#0d0e22]/50 rounded-3xl p-8 border border-white/10 shadow-sm">
              <div className="text-slate-300 mb-4 opacity-80 flex justify-center">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
              </div>
              <h3 className="text-sm font-bold text-white mb-3">Businesses</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
            ...
            <motion.div {...fadeUp(0.2)} className="bg-[#0d0e22]/50 rounded-3xl p-8 border border-white/10 shadow-sm">
              ...
              <h3 className="text-sm font-bold text-white mb-3">Startups</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
            ...
            <motion.div {...fadeUp(0.3)} className="bg-[#0d0e22]/50 rounded-3xl p-8 border border-white/10 shadow-sm">
              ...
              <h3 className="text-sm font-bold text-white mb-3">Students</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
